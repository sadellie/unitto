...
val forceCollection: List<BasicUnit> by lazy {
  listOf(
    ...
    NormalUnit(
      UnitID.ton_force,
      BigDecimal("9806650000000000000000"),
      UnitGroup.FORCE,
    ...
    NormalUnit(
      UnitID.pound_force,
      BigDecimal("4448221615255000000"),
      UnitGroup.FORCE,
    ...
    NormalUnit(
      ...
      BigDecimal("4448221615255000000000"),
      UnitGroup.FORCE,
