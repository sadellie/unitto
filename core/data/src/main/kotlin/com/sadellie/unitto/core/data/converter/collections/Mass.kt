...
internal val massCollection: List<BasicUnit> by lazy {
  listOf(
    NormalUnit(
      ...
      BigDecimal("0.00000000000000000000000000091093897"),
      UnitGroup.MASS,
    ...
    NormalUnit(
      ...
      BigDecimal("0.0000000000000000000000016605402"),
      UnitGroup.MASS,
    ...
    NormalUnit(
      UnitID.venus_mass,
      BigDecimal("4867320000000000000000000000"),
      UnitGroup.MASS,
    ...
    NormalUnit(
      UnitID.earth_mass,
      BigDecimal("5972190000000000000000000000"),
      UnitGroup.MASS,
    ...
    NormalUnit(
      UnitID.mars_mass,
      BigDecimal("641693000000000000000000000"),
      UnitGroup.MASS,
    ...
    NormalUnit(
      UnitID.jupiter_mass,
      BigDecimal("1898130000000000000000000000000"),
      UnitGroup.MASS,
    ...
    NormalUnit(
      UnitID.saturn_mass,
      BigDecimal("568319000000000000000000000000"),
      UnitGroup.MASS,
    ...
    NormalUnit(
      UnitID.uranus_mass,
      BigDecimal("86810300000000000000000000000"),
      UnitGroup.MASS,
    ...
    NormalUnit(
      UnitID.neptune_mass,
      BigDecimal("102410000000000000000000000000"),
      UnitGroup.MASS,
    ...
    NormalUnit(
      UnitID.sun_mass,
      BigDecimal("1989100000000000000000000000000000"),
      UnitGroup.MASS,
