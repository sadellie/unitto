...
internal val volumeCollection: List<BasicUnit> by lazy {
  listOf(
    ...
    NormalUnit(
      ...
      BigDecimal("3785411783999977000"),
      UnitGroup.VOLUME,
    ...
    NormalUnit(
      ...
      BigDecimal("4546089999999954400"),
      UnitGroup.VOLUME,
    ...
    NormalUnit(
      ...
      BigDecimal("1136522500000001400"),
      UnitGroup.VOLUME,
    ...
    NormalUnit(
      UnitID.cubic_foot,
      BigDecimal("28316846590000000000"),
      UnitGroup.VOLUME,
    ...
    NormalUnit(
      UnitID.cubic_yard,
      BigDecimal("764554857983995500000"),
      UnitGroup.VOLUME,
    ...
    NormalUnit(
      UnitID.cubic_mile,
      BigDecimal("4168181825440539000000000000000"),
      UnitGroup.VOLUME,
