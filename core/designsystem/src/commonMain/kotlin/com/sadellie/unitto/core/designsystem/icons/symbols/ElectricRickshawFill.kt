...
val Symbols.ElectricRickshawFill: ImageVector
  get() {
    if (_ElectricRickshawFill != null) {
      return _ElectricRickshawFill!!
    }
    _ElectricRickshawFill =
      ImageVector.Builder(
          name = "ElectricRickshawFill",
          defaultWidth = 24.dp,
          defaultHeight = 24.dp,
          viewportWidth = 960f,
          viewportHeight = 960f,
        ...
        .apply {
          path(fill = SolidColor(Color(0xFFE3E3E3))) {
            ...
            close()
            moveTo(268.5f, 588.5f)
            quadTo(280f, 577f, 280f, 560f)
            reflectiveQuadToRelative(-11.5f, -28.5f)
            quadTo(257f, 520f, 240f, 520f)
            reflectiveQuadToRelative(-28.5f, 11.5f)
            quadTo(200f, 543f, 200f, 560f)
            reflectiveQuadToRelative(11.5f, 28.5f)
            quadTo(223f, 600f, 240f, 600f)
            reflectiveQuadToRelative(28.5f, -11.5f)
            close()
            moveTo(828.5f, 588.5f)
            quadTo(840f, 577f, 840f, 560f)
            reflectiveQuadToRelative(-11.5f, -28.5f)
...
@Suppress("ObjectPropertyName") private var _ElectricRickshawFill: ImageVector? = null
