...
internal class KeyDecoder(private val arguments: Map<String, Any>) : AbstractDecoder() {
  ...
  /**
   * Decodes the index of the next element to be decoded. Index represents a position of the current
   * element in the [descriptor] that can be found with [descriptor].getElementIndex.
   *
   ...
   * method returns [Companion.DECODE_DONE], which indicates that there are no more arguments to
   * decode.
   *
